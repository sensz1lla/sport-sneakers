...
function App() {
  ...
  React.useEffect(() => {
    ...
    axios.get('https://6212a407f43692c9c6efc1e9.mockapi.io/favorites').then((res) => {
  ...
  const onAddToFavorite = async (obj) => {
    try {
      if (favorites.find(favObj => favObj.id == obj.id)) {
        axios.delete(`https://6212a407f43692c9c6efc1e9.mockapi.io/favorites/${obj.id}`);
      } else {
        const { data } = await axios.post('https://6212a407f43692c9c6efc1e9.mockapi.io/favorites', obj);
